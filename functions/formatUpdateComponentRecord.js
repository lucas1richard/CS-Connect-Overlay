...
export default function formatUpdateComponentRecord() {
  ...
  if (window.location.href.indexOf('CheckPublished') > -1) {
    document
      .getElementById('ItemLevelID')
      .value = 11;
    document
      .querySelector('body > table > tbody > tr:nth-child(2) > td > form > input.btn.btn-primary.btn-xs')
      .click();
  }
  ...
  function addMessageDiv() {
    ...
    staffNotesTxtArea
      .parentNode
      .insertBefore(msgDiv, staffNotesTxtArea);
    $('#rArr').hide();
